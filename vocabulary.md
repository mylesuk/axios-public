...
If any of these appear in a handoff, the register has drifted.

- "Hustle", "grind", "ship faster", "move quickly", "don't miss" — velocity language.
- "Crush it", "10x", "unlock", "unfair advantage", "cheat code" — growth-hack register.
- "Audience of true fans", "tribe", "followers" — community-marketing register. Say *reader* or *audience*.
...
- **Prophetic**, **disciplined strike**, **grievance** — the three civilizational registers (see [`persona-voice.md`](persona-voice.md)).
